    ...
    <nav className="primary_nav">
      ...
      <ul className="navigation_list">
        <li className="navation_item">
          ...
          >
            <a href="#home" className="navigation_link">
        ...
        <li className="navation_item">
          ...
          >
            <a href="#movie" className="navigation_link">
              <svg width="20" height="20" xmlns="http://www.w3.org/2000/svg">
        ...
        <li className="navation_item">
          ...
          >
            <a href="#tv-series" className="navigation_link">
              <svg width="20" height="20" xmlns="http://www.w3.org/2000/svg">
        ...
        <li className="navation_item">
          <button className="navigation_btn">
            <a href="#bookmarked" className="navigation_link">
