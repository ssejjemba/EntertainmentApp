    ...
    <nav className="primary_nav">
      ...
      <ul className="navigation_list">
        <li className="navation_item">
          <button
            className="navigation_btn navigation_link"
            onClick={() => setMovieCategory(FILTERS.TEXT)}
          >
        ...
        <li className="navation_item">
          <button
            className="navigation_btn navigation_link"
            onClick={() => setMovieCategory(FILTERS.MOVIES)}
          >
            <svg width="20" height="20" xmlns="http://www.w3.org/2000/svg">
        ...
        <li className="navation_item">
          <button
            className="navigation_btn navigation_link"
            onClick={() => setMovieCategory(FILTERS.TV_SHOWS)}
          >
            <svg width="20" height="20" xmlns="http://www.w3.org/2000/svg">
        ...
        <li className="navation_item">
          <button className="navigation_btn navigation_link">
